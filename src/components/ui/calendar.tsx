      ...
      <DayPicker
        ...
        classNames={{
          ...
          nav_button: cn(
            ...
            "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-700"
          ),
          ...
          day: cn(
            ...
            "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100"
          ),
          ...
          day_range_middle:
            "aria-selected:bg-blue-200 dark:aria-selected:bg-blue-800 aria-selected:text-blue-900 dark:aria-selected:text-blue-100",
